...
export const logo: Logo[] = [
  { src: "https://www.myanmarpaymentunion.com/images/mpu_logo.png" },
  {
...
export const chooseHowToPay: ChooseHowToPay[] = [
  {
    id: "1",
    p1: "Pay in full",
    p2: "Pay the total ($533.47) now and you're all set.",
  },
  {
    id: "2",
    p1: "Pay part now",
    p2: "$266.74 due today, $266.73 on Jul 9, 2023. No extra fees.",
  },
];

export const yourTrip: YourTrip[] = [
  { p1: "Date", p2: "Jul 24-29", p3: "Edit" },
  { p1: "Guest", p2: "1", p3: "Edit" },
];

export const method: Methods[] = [
  { id: "string", label: "Credit or debit card" },
  { id: "string", label: "PayPal" },
  { id: "string", label: "Google" },
];

export const priceDetails: PriceDetails[] = [
  { p1: "$488.11 x 5 nights", p2: "$2,440.54" },
  { p1: "Cleaning fee", p2: "$25.89" },
  { p1: "PocketRents service fees", p2: "$349.61" },
];
